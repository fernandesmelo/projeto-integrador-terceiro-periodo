...
// Registra componentes do Chart.js necessários
ChartJS.register(ArcElement, Tooltip, Title);

/**
 * StatusPieChart Component
 *
 * Faz fetch dos dados de status e renderiza um gráfico de pizza com legenda customizada.
 *
 * Props:
 * - endpoint (string): URL para buscar os dados de status (retorna array de { status, casos }).
 */
